...
class DCGenerator(nn.Module):
    ...
    def __init__(self, input_vec_ch, out_ch_scaler: int=64, out_ch_multiplier: list[int] = [8, 4, 2, 1], out_image_ch=3):
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, input_image_ch: int = 3, out_ch_scaler: int = 64, out_ch_multiplier: list[int] = [1, 2, 4, 8]):
        ...
        self.conv_block1 = ConvNormLRelu(in_channels=_out_ch[0], out_channels=_out_ch[1], bias_channels=_out_ch[1], kernel_size=4, stride=2, padding=1)
